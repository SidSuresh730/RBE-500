...
static const _InvKin_Request_type_support_symbol_names_t _InvKin_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scara_interfaces, srv, InvKin_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, scara_interfaces, srv, InvKin_Request)),
  }
};
...
{
  return &::scara_interfaces::srv::rosidl_typesupport_cpp::InvKin_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, scara_interfaces, srv, InvKin_Request)() {
  return get_message_type_support_handle<scara_interfaces::srv::InvKin_Request>();
}
...
static const _InvKin_Response_type_support_symbol_names_t _InvKin_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scara_interfaces, srv, InvKin_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, scara_interfaces, srv, InvKin_Response)),
  }
};
...
{
  return &::scara_interfaces::srv::rosidl_typesupport_cpp::InvKin_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, scara_interfaces, srv, InvKin_Response)() {
  return get_message_type_support_handle<scara_interfaces::srv::InvKin_Response>();
}
...
static const _InvKin_type_support_symbol_names_t _InvKin_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scara_interfaces, srv, InvKin)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, scara_interfaces, srv, InvKin)),
  }
};
...
{
  return &::scara_interfaces::srv::rosidl_typesupport_cpp::InvKin_service_type_support_handle;
}
