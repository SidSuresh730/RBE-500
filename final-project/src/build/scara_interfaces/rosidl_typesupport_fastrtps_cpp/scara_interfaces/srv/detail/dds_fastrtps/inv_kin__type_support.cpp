...
#include "scara_interfaces/srv/detail/inv_kin__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const scara_interfaces::srv::InvKin_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<scara_interfaces::srv::InvKin_Request *>(
    untyped_ros_message);
...
{
  return &scara_interfaces::srv::typesupport_fastrtps_cpp::_InvKin_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const scara_interfaces::srv::InvKin_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<scara_interfaces::srv::InvKin_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &scara_interfaces::srv::typesupport_fastrtps_cpp::_InvKin_Response__handle;
}
...
{
  return &scara_interfaces::srv::typesupport_fastrtps_cpp::_InvKin__handle;
}
