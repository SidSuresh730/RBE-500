...
bool scara_interfaces__srv__inv_kin__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("scara_interfaces.srv._inv_kin.InvKin_Request", full_classname_dest, 44) == 0);
  }
  scara_interfaces__srv__InvKin_Request * ros_message = _ros_message;
  {  // x
...
PyObject * scara_interfaces__srv__inv_kin__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("scara_interfaces.srv._inv_kin");
...
ROSIDL_GENERATOR_C_EXPORT
bool scara_interfaces__srv__inv_kin__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("scara_interfaces.srv._inv_kin.InvKin_Response", full_classname_dest, 45) == 0);
  }
  scara_interfaces__srv__InvKin_Response * ros_message = _ros_message;
  {  // t1
